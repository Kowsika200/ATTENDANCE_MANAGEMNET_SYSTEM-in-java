...
public class Attend1 extends JFrame implements ActionListener{
	Attend1(){
		...
		try {
			File f3=new File("C:\\Users\\admin\\Desktop\\Attend1.txt");
		...
		l6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==l6) {
					try {
						File f1=new File("C:\\Users\\admin\\Desktop\\StudentList.txt");
						...
						while(rd.hasNextLine()) {
							...
							if(x1.equals((String)l2.getSelectedItem()) && x2.equals((String)l4.getSelectedItem()) && x3.equals(l8.getText())) {
								File f2=new File("C:\\Users\\admin\\Desktop\\Attend1.txt");
